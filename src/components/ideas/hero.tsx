...
import ideas_logo from "@/assets/logo-ideas.webp";
      ...
      <div className="relative flex flex-col justify-center items-center">
        <div className="relative flex flex-col justify-center items-center">
          <div className="relative flex justify-center items-center">
            <div
              data-aos="fade-up"
              className="z-40 relative flex justify-center items-center border-white overflow-hidden hijau-ideas
        ...
        >
          <Link
            to="/registration/ideas/register"
